...
var cumpleaños= new Date( "mayo 19 2022");
...
console.log("faltan "+ diasDIFF +" dias para mi cumpleaños");

console.log("Definir un sistema que cargue la fecha y si ese día el usuario cumple años arrojar un mensaje ");

var fechaCumpleañosbernardo= new Date("december 9 2021");
var mescumpleañosbernardo=fechaCumpleañosbernardo.getMonth();
var diacumpleañosbernardo=fechaCumpleañosbernardo.getDate();
...
if(mescumpleañosbernardo===fechaHoycumpleañosmes && diacumpleañosbernardo===fechaHoycumpleañosdia ){
console.log("feliz cumpleaños Estevan")
}else{console.log("nadie cumple años hoy")};
 console.log("Cuantos años voy a cumplir");

 var fechaNacimiento= new Date("mayo 19 2002");
